// Firebase 動態載入（不使用 ES module import，確保函式在全域可用）
async function initFirebase() {
  const { initializeApp } = await import("https://www.gstatic.com/firebasejs/11.6.0/firebase-app.js");
  const { getAuth, createUserWithEmailAndPassword, signInWithEmailAndPassword, onAuthStateChanged, signOut: fbSignOut, updateProfile } = await import("https://www.gstatic.com/firebasejs/11.6.0/firebase-auth.js");
  const { getFirestore, collection, doc, setDoc, onSnapshot, query, orderBy, writeBatch } = await import("https://www.gstatic.com/firebasejs/11.6.0/firebase-firestore.js");
...
initFirebase().catch(e => console.error('Firebase init failed:', e));
